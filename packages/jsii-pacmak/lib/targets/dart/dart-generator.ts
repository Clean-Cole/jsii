...
export class DartGenerator extends Generator {
  ...
  private dotnetRuntimeGenerator!: DartRuntimeGenerator;

  private dotnetDocGenerator!: DartDocGenerator;
  ...
  public generate(fingerprint: boolean) {
    ...
    this.dotnetRuntimeGenerator = new DartRuntimeGenerator(
      this.code,
      this.typeresolver,
    );
    this.dotnetDocGenerator = new DartDocGenerator(
      this.code,
      this.rosetta,
      this.assembly,
    );
